 ...
 * - The V3 shell and `run-agent` edge function currently use the AURA delivery-agent family (`narrative`, `plan`, `risk`, etc.).
...
export const AGENT_REGISTRY: Record<AgentId, AgentDef> = {
  strategist: {
    ...
    maxTokens: 900,
    systemPromptAddendum: `You are the AURA Strategy & Value specialist. Focus exclusively on: business problem clarity, executive mandate strength, KPI definition, ROI framing, value hypothesis, and baseline metrics. Be specific and evidence-based. Reference actual metrics and mandate data from context. Ignore architecture and governance questions.`,
  },
  architect: {
    id: "architect",
  ...
  insight: {
    ...
    maxTokens: 700,
    systemPromptAddendum: `You are the AURA Data & Insight specialist. Focus exclusively on: quantitative KPI comparison (actual vs baseline), ROI and value realization calculations, performance benchmark analysis, model drift data, and cost efficiency. Always cite specific numbers from context.`,
  },
  coach: {
    id: "coach",
    ...
    maxTokens: 600,
    systemPromptAddendum: `You are the AURA Methodology Coach. Focus exclusively on: explaining AURA phases, guiding what to do next, clarifying exit criteria, recommending artifacts to produce, and answering how-to questions. Be prescriptive and action-oriented.`,
  },
};
