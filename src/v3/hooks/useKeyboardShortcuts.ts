...
export const SHORTCUT_REGISTRY: Omit<ShortcutDef, "action">[] = [
  ...
  { key: "g", description: "Go to Delivery mode", scope: "Navigation" },
  { key: "d", description: "Go to Governance mode", scope: "Navigation" },
  { key: "o", description: "Go to Oversight mode", scope: "Navigation" },
