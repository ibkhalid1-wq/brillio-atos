...
const WORKSPACE_GROUPS: Array<{
  ...
  },
  {
    ...
    tiles: [
      ...
      { view: "ontology", label: "Objective Confidence", description: "Objective-attainment confidence — will the business objectives be met, and what raises that confidence", icon: "⬢", accent: "purple" },
