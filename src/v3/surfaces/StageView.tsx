...
export default function StageView({
  ...
  const phaseArtifacts = useMemo(() => {
    ...
    // Produced artifacts the methodology/dynamic catalogue does not declare (e.g.
    // a Completion Forecast generated by an analysis agent in Strategy). They are
    // kept separate from `byKey` so the required-spine gates (bulk approve, the
