    ...
    <div className="v3fs-app">
      ...
      <div className="v3fs-wrap">
        <header className="v3fs-hero">
          ...
          <h1>Conversations in. Systems out.</h1>
          <div className="v3fs-hero-row">
            <div className="v3fs-count">
              ...
              <div className="v3fs-count-l">
                {days != null
                  ? (days >= 0 ? "until every stakeholder watches their own workflow run" : "past the first-demo target — reset it in Frame")
                  : "set a first-demo date in Frame — days-to-demo is the metric here"}
              </div>
            </div>
            <div className="v3fs-paste">⤓ <span><b>Paste evidence into any movement.</b> ATOS files it, re-reads everything, and redraws what changed.</span></div>
          </div>
          <div className="v3fs-grammar">
            <span><i style={{ background: "var(--v3-accent-b)" }} /> What people said</span>
            <span><i style={{ background: "var(--v3-accent)" }} /> What ATOS made</span>
            <span><i style={{ background: "var(--v3-green)" }} /> What was demonstrated</span>
          </div>
        </header>
  ...
  return (
    <div className="v3fs-grid2">
      <div className="v3fs-panel">
        <div className="v3fs-ph"><h3>Evidence</h3><span>every conversation the programme has heard</span></div>
        {evidence.length === 0 ? <div className="v3fs-empty">Nothing heard yet — paste the first conversation into Frame or Listen.</div> : null}
      ...
      <div className="v3fs-panel">
        <div className="v3fs-ph"><h3>Artifacts</h3><span>living documents — regenerate when evidence moves</span></div>
  ...
  return (
    <div className="v3fs-pulse">
      <div className="v3fs-stats">
        ...
        <div className="v3fs-stat"><div className="v3fs-stat-n"><b>{coverage.done}</b><small>/{coverage.total || "?"}</small></div><div className="v3fs-stat-l">voices heard</div></div>
        <div className="v3fs-stat"><div className="v3fs-stat-n"><b>{demos.accepted}</b><small>/{demos.total || "?"}</small></div><div className="v3fs-stat-l">demos accepted</div></div>
      ...
      <div className="v3fs-grid2">
        <div className="v3fs-panel">
          <div className="v3fs-ph"><h3>The demo tour</h3><span>the gate, person by person</span></div>
          {demos.rows.length === 0 ? <div className="v3fs-empty">The tour ledger fills as demos are booked in Show.</div> : null}
        ...
        <div className="v3fs-panel">
          <div className="v3fs-ph"><h3>Outcomes</h3><span>their numbers, not estimates</span></div>
          {kpis.length === 0 ? <div className="v3fs-empty">Success KPIs land here from Frame — baselines extracted from the conversations.</div> : null}
          {kpis.map((kpi, i) => (
