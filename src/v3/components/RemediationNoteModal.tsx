    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: 13, color: "var(--v3-text-secondary)", marginBottom: 18, lineHeight: 1.5, fontFamily: "var(--v3-font)" }}>
          Describe the issues that need fixing before this gate can be approved. This will be added to the programme audit trail.
        </div>
        <textarea
          autoFocus
          value={note}
          onChange={(e) => setNote(e.target.value)}
          placeholder="Describe the issues that need fixing (e.g. missing exit criteria, outstanding risks, incomplete artefacts)…"
