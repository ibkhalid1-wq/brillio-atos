export const COPY = {
  ...
  onboarding: {
    welcomeTitle: "Welcome to Brillio ATOS",
    welcomeBody: "Brillio's Agentic Transformation OS guides your programme from strategy to value realisation. Let's set it up.",
