...
-- NEXT: apply supabase/migrations/20260807_audit_events.sql on this project, then
-- run scratch_02_contract_checks.sql, scratch_03_cost_measure.sql, scratch_04_reversibility.sql.
